...
class TestsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            locale.setlocale(locale.LC_ALL, self.locale)
        self.index =  indexer.TinaIndex( "tests/" )
    ...
    def test0index(self):
        ...
        self.index.indexDocs( tinaImporter.docDict.values() )
        # second indexation with overwrite=False (default)

        notIndexedTwoTimes = self.index.indexDocs( tinaImporter.docDict.values() )
