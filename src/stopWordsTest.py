...
# pytextminer modules
from PyTextMiner.StopWord import StopWords
...
class TestStopWords(unittest.TestCase):
    ...
    def test_basic(self):
        stopwords = StopWords(['cat','I','a','dog'])
...
z
        ...
        stopwords = StopWords([["dog"],["I","like"],["you","have"]])
        self.assertEquals(stopwords.clean(
    ...
    def test_locale(self):
        stopwords = StopWords(['cat','dog'],locale='en_US')

    def test_nltk_en(self): 
        stopwords = StopWords("nltk://english", locale="en_US")
        self.assertEquals(
              stopwords.clean(
    ...
    def test_nltk_fr(self):    
        stopwords = StopWords("nltk://french", locale="fr_FR")
        self.assertEquals(
              stopwords.clean(
    ...
    def test_file_en(self):
        stopwords = StopWords("file://t/stopwords/en.txt", locale="en_US")
    ...
    def test_file_fr(self):
        stopwords = StopWords("file://t/stopwords/fr.txt", locale="fr_FR")
